...
```{r eval= TRUE, include=TRUE, echo=FALSE, fig.height=2.25, fig.width=5, fig.align='center'}
# Visualization 1
...
cat("The probability for a divorce related to be asked is:",predict1)
...
<!-- cat("The probability for a divorce related to be asked is:",predict2) -->
<!-- ``` -->
