...
For allowed income, after adjusting for all the confounders (Locations(state), number in household, age, marital status, savings balance, checking balance, allowed income) the odd ratio is 1.0000002, with 95% CI being 0.9999 and 1.000007.  The confidence interval crossed 1, which means there is no difference between clients with different annual income so it’s not significant for our prediction.

For savings balance, after adjusting for all the cofounders, the odd ratio is 0.9999816, with 95% CI being 0.999727 and 0.9999904. The confidence interval did not cross 1, which means there is difference between clients of different saving balance when it comes to the odds of asking questions related to divorce. This means that the odds of client asking question related to divorce will decrease by 0.0184% for every unit increases of client’s savings balance with true population effect between 0.0273% and 0.00096%.

For checking balance, the odd ratio is 0.9999608, with 95% CI being 0.9999438 and 0.9999777. The confidence interval did not cross 1, which means there is difference between clients of different checking balance when it comes to the odds of asking questions related to divorce. The influence of checking balance on the odds of clients asking divorce related question is equally weak as that of saving balance

For state, let’s take Wyoming(StateAbbrWY) as an example, after adjusting for all the cofounders(Age, number in household, marital status, annual income, savings balance, checking balance, allowed income) the odds ratio is 1.388847 with 95% CI being 1.040919 to 1.853070. The confidence interval did not cross 1, which means there is difference between clients from different states when it comes to the odds of asking questions related to divorce.  This means that the odds for clients from the state of wyoming to ask question related divorce is 1.39 times more likely than the clients from other states, with the true population effect between 1.040919 to 1.853070.  

On the other hand, the state Alabama(StateAbbrAL), after adjusting for all the cofounders(Age, number in household, marital status, annual income, savings balance, checking balance, allowed income) the odds ratio is 0.5794145 with 95% CI being 0.3988555 to 0.8417113. The confidence interval did not cross 1, which means there is difference between clients from different states when it comes to the odds of asking questions related to divorce.  This means that the odds for clients from the state of wyoming to ask question related divorce is 42.05855% less likely to talk about divorce related issues than the clients from other states.
