...
# state_divorce <- 
plot_usmap(data = divorce_distrib, values = "Freq", color = "red", labels = TRUE) + 
...
```{r setup, include=TRUE}
data_overall %>%
ggplot(aes(x = average_complexity, y = average_rating, color = game_type)) +
  geom_point() +
  geom_smooth(color= "black") +
  labs(x = " Average Complexity",
       y = "Average Rating",
